...
codes = [{"code":"11252","system":"gprdproduct"},{"code":"45600","system":"gprdproduct"},{"code":"6518","system":"gprdproduct"},{"code":"6877","system":"gprdproduct"},{"code":"764","system":"gprdproduct"}];
REQUIRED_CODES = 1;
